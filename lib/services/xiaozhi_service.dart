...
class XiaozhiService {
  ...
  // static List<XiaozhiService> _instances = [];

  static String websocketUrl = '';
  static String otaUrl = '';
  static String macAddress = '';
  static String token = '';
  static String? _sessionId; // 会话ID将由服务器提供
  ...
  XiaozhiService._internal({
    ...
    XiaozhiService._sessionId = sessionId;
    XiaozhiService.otaUrl = otaUrl;
    XiaozhiService.websocketUrl = websocketUrl;
    XiaozhiService.macAddress = macAddress;
    XiaozhiService.token = token;
    _init();
  }
  ...
  XiaozhiService._resetAddr(
    ...
    XiaozhiService.token = token ?? XiaozhiService.token;
    XiaozhiService._sessionId = _sessionId ?? XiaozhiService._sessionId;
  }
